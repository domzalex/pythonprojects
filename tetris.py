...
def drawGrid(pen, grid) :
    pen.clear()
    top = 230
    left = -115

    colors = ['#000000', '#FFFFFF', '#C7CEEA', '#B5EAD7', '#E2F0CB', '#FFDAC1', '#FFB7B2', '#FF9AA2']
...
def drawScore(pen, score) :
    pen.color('#FFB7B2')
    pen.hideturtle()
    pen.goto(-50, 325)
    pen.write('Score: {}'.format(score), move=False, align='left', font=('Helvetica', 24, 'normal'))


#creating basic shape for start of game
shape = Shape()
